    ...
    <div className="space-y-4">
      ...
      <section className="rounded-lg border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 p-5 space-y-3">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:items-center">
          ...
          {file ? (
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 medichat-animate-in">
              <svg
                viewBox="0 0 24 24"
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-4 py-2 rounded bg-zinc-900 text-white dark:bg-white dark:text-black text-sm font-medium disabled:opacity-50 transition-all active:scale-[0.98]"
            >
              {loading ? (
